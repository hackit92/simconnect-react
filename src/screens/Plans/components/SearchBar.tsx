    ...
    <div className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-12 py-4 text-base bg-gray-50 border-0 rounded-full focus:outline-none focus:ring-0 focus:bg-white transition-all duration-200 placeholder-gray-500"
          autoComplete="off"
        />
