/*
  # Separate metadata into specific database fields

  1. New Columns
    - `data_gb` (numeric): Data amount in GB
    - `validity_days` (integer): Plan validity in days
    - `technology` (text): Network technology (5G, 4G/LTE, 3G, 2G)
    - `has_5g` (boolean): Whether the plan supports 5G
    - `has_lte` (boolean): Whether the plan supports LTE/4G
    - `regular_price_usd` (numeric): Regular price in USD
    - `regular_price_eur` (numeric): Regular price in EUR
    - `regular_price_mxn` (numeric): Regular price in MXN

  2. Indexes
    - Add indexes on new fields for fast filtering and sorting

  3. Data Migration
    - Extract data from existing metadata and populate new fields
    - Update sync function to populate these fields directly
*/
